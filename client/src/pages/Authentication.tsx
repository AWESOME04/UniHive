...
function Authentication() {
  ...
  const [activeScreen, setActiveScreen] = useState<
    "landing" | "login" | "register" | "otp" | "success"
  >("landing");
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">
              Find the best hives at Ghana University
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-600">
              Join UniHive to find the best hives at Ghana University
            </p>
          </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="relative">
                ...
                >
                  <span
                    className={
                      selectedUniversity ? "text-gray-900" : "text-gray-400"
                    }
                  >
                    {selectedUniversity
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <button className="text-secondary font-medium">Resend</button>
              </p>
            </div>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6">
            ...
            <p className="text-center text-gray-600 mb-6">
              You can now access all features of UniHive and find the best hives
              at Ghana University.
            </p>
