...
const ghanaUniversities: University[] = [
  ...
  { 
    ...
    students: '1,200+',
    description: 'Known for its innovative approach to higher education with a focus on ethics and entrepreneurial leadership.',
    established: '2002',
  ...
  { 
    ...
    students: '8,000+',
    description: 'A private Christian university offering diverse programs with a focus on ethical leadership.',
    established: '1988',
  ...
  { 
    ...
    location: 'Winneba', 
    image: 'https://upload.wikimedia.org/wikipedia/en/thumb/7/7c/UEW_logo.jpg/220px-UEW_logo.jpg', 
    students: '18,000+',
    description: 'Specializes in teacher education and educational leadership programs.',
    established: '1992',
  ...
  { 
    ...
    location: 'Tamale', 
    image: 'https://upload.wikimedia.org/wikipedia/en/thumb/3/31/University_for_Development_Studies_logo.svg/1200px-University_for_Development_Studies_logo.svg.png', 
    students: '20,000+',
    description: 'Focuses on programs that promote sustainable development in northern Ghana.',
    established: '1992',
...
const Universities: React.FC = () => {
  ...
  const filteredUniversities = ghanaUniversities.filter(university => {
    ...
    const matchesRegion = regionFilter ? university.location.toLowerCase().includes(regionFilter.toLowerCase()) : true;
      ...
      <div className="bg-primary text-white py-16 px-4 md:px-8 lg:px-16">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Universities in Ghana</h1>
            <p className="text-xl mb-8">
              Discover opportunities at Ghana's top universities and connect with students from across the country.
            </p>
              ...
              <div key={university.id} className="bg-white rounded-xl shadow-sm overflow-hidden transform transition-all duration-300 hover:shadow-md hover:translate-y-[-5px]">
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-primary">{university.name}</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <div className="flex items-center text-gray-500 mb-1">
                        <GraduationCap size={14} className="mr-1 text-secondary" />
                        <span className="text-xs">Established</span>
                      </div>
                      <div className="font-medium">{university.established}</div>
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg">
                      <div className="flex items-center text-gray-500 mb-1">
