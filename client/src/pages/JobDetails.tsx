...
// Mock hive data - in a real app, this would come from an API
const mockJobs = [
  {
    id: "1",
    title: "Python Tutor",
...
function JobDetails() {
  ...
  // Find the hive by ID (in a real app, this would be fetched from an API)
  const hive = mockJobs.find((hive) => hive.id === id) || mockJobs[0];
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          height: "80vw",
          transition:
            "left 0.5s cubic-bezier(0.25, 0.1, 0.25, 1), top 0.5s cubic-bezier(0.25, 0.1, 0.25, 1)",
        }}
      ></div>
                      ...
                      <div className="flex gap-2">
                        <button
                          className={`p-2 rounded-full ${
                            isBookmarked
                              ? "bg-light-orange/20 text-secondary"
                        ...
                        >
                          <Bookmark
                            size={20}
                            className={isBookmarked ? "fill-secondary" : ""}
                          />
                        </button>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center text-gray-600 mb-5 gap-y-2">
                      <span className="flex items-center mr-4">
                        <Building size={16} className="mr-1 text-secondary" />{" "}
                        {hive.company}
                      </span>
                    ...
                    <div className="flex flex-wrap gap-3">
                      <span className="bg-light-orange/30 text-secondary px-4 py-1.5 rounded-full text-sm font-medium flex items-center shadow-sm">
                        <Clock size={14} className="mr-1.5" /> {hive.type}
                      </span>
                      ...
                      <span className="bg-gray-100 text-gray-700 px-4 py-1.5 rounded-full text-sm font-medium flex items-center shadow-sm">
                        <Calendar size={14} className="mr-1.5" /> Posted{" "}
                        {hive.postedAt}
                      </span>
                    </div>
                  </div>
                    ...
                    <div>
                      <div className="mb-8">
                        ...
                        <ul className="space-y-2 mb-6">
                          {hive.requirements.map((req, index) => (
                            <li
                              key={index}
                        ...
                        <div className="space-y-2 mb-6">
                          {hive.deadlines.map((deadline, index) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {Object.entries(hive.information).map(
                            ([key, value]) => (
                              <div
                                key={key}
                  ...
                  {activeTab === "company" && (
                    <div>
                      <div className="flex items-start mb-6">
                        <img
                          src={hive.employer.avatar}
                          alt={hive.employer.name}
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">{hive.employer.title}</p>
                          <div className="flex items-center mt-2 text-sm text-gray-500">
                            <div className="mr-4">
                              <span className="font-medium text-secondary">
                                {hive.employer.response_rate}
                              </span>{" "}
                              Response Rate
                            </div>
                            <div>
                              <span className="font-medium text-secondary">
                                {hive.employer.response_time}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mb-6">
                        <h3 className="text-md font-semibold mb-3 text-primary">
                          About Ghana University
                        </h3>
                        <p className="text-gray-700 mb-4">
                          Ghana University is a prestigious institution of
                          higher learning committed to excellence in education,
                          research, and innovation. The Computer Science
                          department is known for its cutting-edge curriculum
                          and dedicated faculty members who are experts in their
                          fields.
                        </p>
                        <p className="text-gray-700">
                          The university offers a vibrant campus life with
                          numerous opportunities for students to engage in
                          extracurricular activities, research projects, and
                          community service. The Legon Campus is located in a
                          serene environment conducive for learning and academic
                          pursuits.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">
                            See what students say about this employer
                          </p>
                        </div>
                        ...
                        {[
                          {
                            ...
                            date: "2 weeks ago",
                            comment:
                              "Dr. Nkrumah is an excellent mentor. He provided clear guidance and was always available to answer questions. The Python tutoring position was a great learning experience.",
                          },
                          {
                            name: "Michael Osei",
                            avatar:
                            ...
                            date: "1 month ago",
                            comment:
                              "Good experience overall. The hive description was accurate and payment was always on time. Would recommend working with this department.",
                          },
                        ].map((review, index) => (
                          <div
                            key={index}
                    ...
                    <div className="space-y-3">
                      <div className="flex">
                        <div className="bg-light-orange/20 text-secondary p-3 rounded-lg rounded-bl-none max-w-[80%]">
                          <p className="text-sm">
                            Hello! Thank you for your interest in the Python
                            Tutor position. How can I help you?
                          </p>
                  ...
                  {[
                    {
                      ...
                      location: "Ghana University - Kumasi Campus",
                      type: "Full-time",
                      salary: "GH₵65/hr",
                    },
                    {
                      title: "Programming Instructor",
                      location: "Ghana University - Cape Coast Campus",
                      type: "Part-time",
                      salary: "GH₵45/hr",
                    },
                    {
                      title: "Computer Science TA",
                      location: "Ghana University - Accra Campus",
                      type: "Part-time",
                      salary: "GH₵40/hr",
                    },
