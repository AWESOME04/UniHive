      ...
      <AnimatePresence>
        {(!isMobile || isOpen) && (
          ...
          >
            {/* Sidebar header */}
            <div
              className={`px-4 py-5 flex items-center justify-between border-b border-gray-200 ${
                    ...
                    {utilityNavigation.map((item) => {
                      ...
                      return item.href === "/logout" ? (
                        <a
                          ...
                          className={`flex items-center ${
                            isCollapsed ? "justify-center" : ""
                          } px-3 py-2.5 rounded-lg text-sm transition-all duration-200 group text-gray-700 hover:bg-gray-100`}
                        >
